...
class Complaint(models.Model):
    ...
    customer_type_choices = [
        ('Consumer', 'Consumer'), ('Distributor', 'Distributor'),
        ('Retailer', 'Retailer'), ('Other', 'Other')
    ]
    ...
    Persian_year = models.CharField(
        max_length=4, choices=Persian_year_choices, default='1402')
    Persian_month = models.CharField(
        max_length=2, choices=Persian_months_choices, default='01')
    Persian_day = models.CharField(max_length=2, default='01')
    ...
    production_shift = models.CharField(
        ...
        null=True, blank=True)
    # ------------------------Action ----------------------------------- ##
    complaint_status = models.BooleanField(
    ...
    action_date = jDateField(null=True, blank=True)
    action_deadline = jDateField(null=True, blank=True)
    action_responsible = models.CharField(
